                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($buy->estado == 2)
                                        <div class="card-panel teal lighten-2" style="padding: 5px; color: #fff;">{{$buy->updated_at->format('d/m/Y')}}</div>
                                    @else
                                        <div class="card-panel red lighten-2" style="padding: 5px; color: #fff;">{{$buy->updated_at->format('d/m/Y')}}</div>
                                    @endif
                                </td>
                                <td>{{$buy->valor}} USD</td>
