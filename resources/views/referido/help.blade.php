...
<div class="row">
    <div class="col s12 grey lighten-1" style="border-radius: 5px; padding: 10px;">
        ...
        <div id="flow-text-demo" class="card-panel grey lighten-5">
            ...
            <p class="">Te ofrecemos nuestra plataforma para poder encargar de forma rápida y fácil cualquiera gift card de su preferencia. Y un sistema de puntos por los que eres recompensado por cada encargo completado con excitó y por los nuevos usuarios que traigas a nuestra plataforma.</p>
